 ...
 *
 * Layout rules are copied verbatim from /login. When you tune /login,
 * update this file in lock-step — the intentional duplication keeps
 * the design language 1:1 without introducing a shared wrapper that
      ...
      >
        ...
        <div className="flex flex-col px-6 md:px-12 py-10 md:py-14 relative">
          ...
          {/* Headline stack — same two-tone composition as /login,
              sized for the narrower single-column card. */}
