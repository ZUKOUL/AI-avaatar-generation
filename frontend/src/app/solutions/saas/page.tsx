...
export const metadata = {
  ...
  description:
    "Démos produit en 5 minutes, ads LinkedIn qui convertissent, testimonials clients IA (avec leur accord). CAC SaaS B2B -40% en 2 mois. Tes features shippent, ton marketing suit.",
};
