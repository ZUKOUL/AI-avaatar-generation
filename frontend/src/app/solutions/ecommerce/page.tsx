...
export const metadata = {
  ...
  description:
    "Remplace ton shooting produit, ton UGC creator et ton ad buyer par Horpen. Génère tes visuels, tes UGC vidéo et 50 variantes d'ads — 2-3× moins cher que les agences, en 48h au lieu de 2 semaines.",
};
